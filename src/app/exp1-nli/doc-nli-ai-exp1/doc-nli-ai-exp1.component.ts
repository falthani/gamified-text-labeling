...
@Component({
  selector: 'app-doc-nli-ai-exp1',
  templateUrl: './doc-nli-ai-exp1.component.html',
  styleUrls: ['./doc-nli-ai-exp1.component.scss'],
})
export class DocNliAiExp1Component implements OnInit {
