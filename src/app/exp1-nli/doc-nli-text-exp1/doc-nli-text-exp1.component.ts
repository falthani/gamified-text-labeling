...
@Component({
  selector: 'app-doc-nli-text-exp1',
  templateUrl: './doc-nli-text-exp1.component.html',
  styleUrls: ['./doc-nli-text-exp1.component.scss'],
})
export class DocNliTextExp1Component implements OnInit {
