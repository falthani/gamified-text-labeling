...
import { DocEmoWdsDialogComponent } from '../doc-emo-wds-dialog/doc-emo-wds-dialog.component';
...
@Component({
selector: 'app-doc-emo-wds-exp2',
templateUrl: './doc-emo-wds-exp2.component.html',
styleUrls: ['./doc-emo-wds-exp2.component.scss'],
})
export class DocEmoWdsExp2Component {
...
openBottomSheet(): void {
  const bottomSheetRef = this.bottomSheet.open(DocEmoWdsDialogComponent, {
    data: {
