...
@Component({
  selector: 'app-doc-puz-wds-dialog',
  templateUrl: './doc-puz-wds-dialog.component.html',
  styleUrls: ['./doc-puz-wds-dialog.component.scss'],
  encapsulation: ViewEncapsulation.None  // Disable encapsulation
})
export class DocPuzWdsDialogComponent {
  shuffledDefinitions: {
    definition: string;
    color: string;
    examples: string[];
  ...
  constructor(
    private _bottomSheetRef: MatBottomSheetRef<DocPuzWdsDialogComponent>,
