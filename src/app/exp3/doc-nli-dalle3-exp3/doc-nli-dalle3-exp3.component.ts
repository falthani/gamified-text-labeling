...
@Component({
  selector: 'app-doc-nli-dalle3-exp3',
  templateUrl: './doc-nli-dalle3-exp3.component.html',
  styleUrls: ['./doc-nli-dalle3-exp3.component.scss']
})
export class DocNliDalle3Exp3Component {
