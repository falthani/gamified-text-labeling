...
@Component({
  ...
  templateUrl: './doc-gi-img-exp1.component.html',
  styleUrls: ['./doc-gi-img-exp1.component.scss'],
})
export class DocGiImgExp1Component implements OnInit {
