...
@Component({
  selector: 'app-doc-nlp-pos-exp1',
  templateUrl: './doc-nlp-pos-exp1.component.html',
  styleUrls: ['./doc-nlp-pos-exp1.component.scss'],
})
export class DocNlpPosExp1Component implements OnInit {
  firestore: Firestore;
  ...
  openBottomSheet(posTagItem: any): void {
    ...
    if (posTagItem >= 0 && posTagItem < this.posTagItems.length) {
      ...
      const bottomSheetRef = this._bottomSheet.open(DocNlpDialogExp1Component);
