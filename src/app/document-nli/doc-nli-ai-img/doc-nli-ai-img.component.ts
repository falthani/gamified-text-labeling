...
@Component({
  selector: 'app-doc-nli-ai-img',
  templateUrl: './doc-nli-ai-img.component.html',
  styleUrls: ['./doc-nli-ai-img.component.scss'],
})
export class DocNliAiImgComponent implements OnInit {
